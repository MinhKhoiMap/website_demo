...
import StudioLabCategory from "./category";
          ...
          <div className="row justify-between mb-[78px]">
            <div className="col-5">
              ...
              <h3 className="text-sm text-justify font-normal mb-4 mt-6">
                Lorem ipsum dolor sit amet consectetur. Velit donec
                pellentesque egestas rutrum dictumst congue sem in. Sapien
                pulvinar augue dui est. Arcu quis in tortor congue cursus. Vitae
                in natoque amet non. Consectetur scelerisque adipiscing nunc
                leo. Ultrices elit sed lorem vitae lectus. In nisl tortor aenean
                venenatis nisi enim imperdiet. Amet nulla eget etiam tincidunt
                sagittis neque. Nunc bibendum nunc turpis condimentum bibendum
                at sit porttitor et.
              </h3>
